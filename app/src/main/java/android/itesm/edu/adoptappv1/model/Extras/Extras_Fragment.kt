...
class Extras_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(android.itesm.edu.adoptappv1.R.layout.extras_fragment, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for (i in 0..2) {
            extras.add(
                Extra("Pelota",false,"kong","120","es un apelota","https://firebasestorage.googleapis.com/v0/b/adogtapp-4fe6a.appspot.com/o/extras%2FJuguete1.jpg?alt=media&token=0ec3269c-4301-40dd-91cc-9b71073bd825")
            )
